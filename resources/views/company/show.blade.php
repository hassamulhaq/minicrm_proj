                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card card-widget widget-user">
                        <div class="widget-user-header bg-info">
                            <h2 class="widget-user-username mb-2"> {{ Str::title($company->name) }} </h2>
                            <h5 class="widget-user-desc">{{ __('Created At') }} {{ \Carbon\Carbon::parse($company->created_at)->format('Y-m-d') }}</h5>
                        </div>
